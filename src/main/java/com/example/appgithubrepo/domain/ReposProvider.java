...
public class ReposProvider {
    ...
    public List<ReposResponseDto> getAllRepo(String userName) {
        ...
        List<ReposResponseDto> reposResponseDtoList = allRepo.stream().map(RepoMapper::mapFromRepoToGetAllReposResponseDto).toList();
        log.info("list of repos successfully returned");
